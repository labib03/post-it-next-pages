export default function PostSkeleton() {
  return (
    <div role="status" className="animate-pulse p-6 border-2 rounded-lg">
      ...
      <div className="flex items-center gap-1 mt-2">
        <span className="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 w-20" />{" "}
        -{" "}
        <span className="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 w-40" />
      </div>
